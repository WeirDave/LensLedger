...
<nav class="menu-panel" id="menuPanel"><a href="/people-review">👥 Review people ({review_count:,})</a><a href="/faces-review">🙂 Name faces ({unidentified_faces_count:,})</a><button type="button" data-panel="library">📁 Open photo library</button><a href="/map">🌍 Photo map</a><a href="/scan-photos">🔎 Scan your photos</a><button type="button" id="updateMenu" data-panel="update">⬆ Check for updates</button><button type="button" data-panel="trash">Trash &amp; restore ({trash_count})</button><button type="button" data-panel="guide">Quick guide</button><a href="https://github.com/WeirDave/LensLedger/issues" target="_blank" rel="noopener">❓ Help &amp; support</a><button type="button" data-panel="about">About LensLedger</button></nav>
...
<nav class="menu-panel" id="menuPanel"><a href="/">📷 Photo library</a><a href="/faces-review">🙂 Name faces</a><a href="/scan-photos">🔎 Scan photos</a><a href="/map">🌍 Photo map</a><a href="https://github.com/WeirDave/LensLedger/issues" target="_blank" rel="noopener">❓ Help &amp; support</a></nav>
...
<nav class="menu-panel" id="menuPanel"><a href="/">📷 Photo library</a><a href="/people-review">👥 Review people</a><a href="/scan-photos">🔎 Scan photos</a><a href="/map">🌍 Photo map</a><a href="https://github.com/WeirDave/LensLedger/issues" target="_blank" rel="noopener">❓ Help &amp; support</a></nav>
