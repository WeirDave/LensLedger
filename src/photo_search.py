...
<script src="{asset_url('js/scan-photos.js')}" defer></script>
    ...
    def viewer_page(self, params):
        ...
        page = f"""<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>{APP_NAME} — {APP_TAGLINE}</title><link rel="icon" href="/logo.png"><link rel="stylesheet" href="{asset_url('css/viewer.css')}"></head><body class="{body_class}" {bootstrap_attr({
