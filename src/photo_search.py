...
<script src="{asset_url('js/theme.js')}"></script></head><body><header><a class="back" href="/">← Photo library</a><img src="/logo.png?v={APP_VERSION}" alt=""><div><h1>Photo map</h1><p>Embedded locations from the current library · read-only and kept local</p></div><span class="spacer"></span><nav class="quick-nav"><a href="/scan-photos">🔎 Scan photos</a><a href="/people-review">👥 Review people</a></nav><button type="button" class="theme-toggle" aria-label="Toggle theme"></button><span class="count" id="count">Loading locations…</span></header>
...
<div class="menu-backdrop" id="menuBackdrop"></div><nav class="menu-panel" id="menuPanel"><div class="menu-panel-header"><div class="menu-panel-brand"><img src="/logo.png?v={APP_VERSION}" alt=""><div class="menu-panel-brand-text"><span class="menu-panel-title">{APP_NAME}</span><span class="menu-panel-tagline">{APP_TAGLINE}</span><span class="menu-panel-version">v{APP_VERSION}</span></div></div><button type="button" class="menu-close-btn" id="menuClose">&times;</button></div><div class="menu-body"><div class="menu-section-label">Navigation</div><a class="menu-item" href="/people-review">👥 Review people<span class="menu-badge">{review_count:,}</span></a><a class="menu-item" href="/faces-review">🙂 Name faces<span class="menu-badge">{unidentified_faces_count:,}</span></a><a class="menu-item" href="/map">🌍 Photo map</a><a class="menu-item" href="/scan-photos">🔎 Scan your photos</a><div class="menu-divider"></div><div class="menu-section-label">Tools</div><button type="button" class="menu-item" data-panel="library">📁 Open photo library</button><button type="button" class="menu-item" data-panel="trash">🗑 Trash &amp; restore<span class="menu-badge">{trash_count}</span></button><button type="button" class="menu-item" id="updateMenu" data-panel="update">⬆ Check for updates</button><div class="menu-divider"></div><div class="menu-section-label">Help &amp; Support</div><button type="button" class="menu-item" data-panel="guide">📖 Quick guide</button><a class="menu-item" href="https://github.com/WeirDave/LensLedger/issues" target="_blank" rel="noopener">❓ Help &amp; support</a><button type="button" class="menu-item" onclick="copyDiagnostics()">📋 Copy diagnostics</button><button type="button" class="menu-item" data-panel="about">ℹ About {APP_NAME}</button></div></nav>
...
<div class="menu-backdrop" id="menuBackdrop"></div><nav class="menu-panel" id="menuPanel"><div class="menu-panel-header"><div class="menu-panel-brand"><img src="/logo.png?v={APP_VERSION}" alt=""><div class="menu-panel-brand-text"><span class="menu-panel-title">{APP_NAME}</span><span class="menu-panel-tagline">{APP_TAGLINE}</span><span class="menu-panel-version">v{APP_VERSION}</span></div></div><button type="button" class="menu-close-btn" id="menuClose">&times;</button></div><div class="menu-body"><div class="menu-section-label">Navigation</div><a class="menu-item" href="/">📷 Photo library</a><a class="menu-item" href="/faces-review">🙂 Name faces</a><a class="menu-item" href="/scan-photos">🔎 Scan photos</a><a class="menu-item" href="/map">🌍 Photo map</a><div class="menu-divider"></div><div class="menu-section-label">Help &amp; Support</div><a class="menu-item" href="https://github.com/WeirDave/LensLedger/issues" target="_blank" rel="noopener">❓ Help &amp; support</a><button type="button" class="menu-item" onclick="copyDiagnostics()">📋 Copy diagnostics</button></div></nav>
