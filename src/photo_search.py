...
<title>Set up {APP_NAME}</title><link rel="icon" href="/logo.png"><link rel="stylesheet" href="{asset_url('css/onboarding.css')}">
...
<script src="{asset_url('js/scan-photos.js')}" defer></script>
    ...
    def viewer_page(self, params):
        ...
        page = f"""<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>{APP_NAME} — {APP_TAGLINE}</title><link rel="icon" href="/logo.png"><link rel="stylesheet" href="{asset_url('css/person-picker.css')}"><link rel="stylesheet" href="{asset_url('css/viewer.css')}"></head><body class="{body_class}" {bootstrap_attr({
...
<script src="{asset_url('js/viewer.js')}" defer></script></body></html>"""
    ...
    def people_review_page(self, params):
        ...
        page = f"""<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>Review people — {APP_NAME}</title><link rel="icon" href="/logo.png"><link rel="stylesheet" href="{asset_url('css/person-picker.css')}"><link rel="stylesheet" href="{asset_url('css/people-review.css')}">
