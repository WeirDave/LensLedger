...
class UpdaterTests(unittest.TestCase):
    ...
    def test_legacy_catalog_is_backed_up_migrated_and_registered(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertEqual(migrated_asset_path, runtime / "Review Bin" / "one.jpg")
            self.assertEqual(migrated_review_path, runtime / "Review Bin" / "one.jpg")
            self.assertEqual(migrated_backup_path, runtime / "Metadata Backups" / "two.jpg")
