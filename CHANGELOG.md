...
- Changed "Copy path" to "Copy filename" so the copied text works with Explorer/Finder search after clicking Open folder.
- Removed non-functional link styling from file paths — now plain selectable text.
